...
// node_modules/@stefanprobst/remark-shiki/src/index.js
var import_parse_numeric_range = __toESM(require_parse_numeric_range());
var MISSING_HIGHLIGHTER = `Please provide a \`shiki\` highlighter instance via \`options\`.
...
function parseMetaDefault(meta) {
  ...
  if (meta.length === 0)
    return void 0;
  try {
    const parsed = dist_default.parse(meta);
    if (parsed.highlight != null) {
      const highlighted = (0, import_parse_numeric_range.default)(parsed.highlight);
      return highlighted.map((line2) => {
        return { line: line2, classes: ["highlighted-line"] };
      });
    }
    return void 0;
  } catch {
...
//# sourceMappingURL=@stefanprobst_remark-shiki.js.map
