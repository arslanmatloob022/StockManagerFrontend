...
var ScrollGrid = class extends BaseComponent {
  ...
  renderChunk(sectionConfig, sectionIndex, colGroupStat, microColGroupNode, chunkConfig, chunkIndex, rowHeights, isHeader) {
    ...
    let content = renderChunkContent(sectionConfig, chunkConfig, {
      ...
      tableMinWidth,
      clientWidth: scrollerClientWidths[index] !== void 0 ? scrollerClientWidths[index] : null,
      clientHeight: scrollerClientHeights[index] !== void 0 ? scrollerClientHeights[index] : null,
      expandRows,
    ...
    content = y(ClippedScroller, { ref: this.clippedScrollerRefs.createRef(index), scrollerElRef: this.scrollerElRefs.createRef(index), overflowX, overflowY, forPrint: this.props.forPrint, liquid: chunkVGrow, maxHeight: sectionConfig.maxHeight }, content);
    ...
    for (let sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
      for (let chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
        ...
        if (scrollerEl) {
          ...
          scrollerClientWidths[index] = Math.floor(harnessEl.getBoundingClientRect().width - (chunkI === sideScrollI && forceYScrollbars ? scrollbarWidth.y : 0));
          scrollerClientHeights[index] = Math.floor(harnessEl.getBoundingClientRect().height - (sectionI === lastSectionI && forceXScrollbars ? scrollbarWidth.x : 0));
        }
      }
    }
...
//# sourceMappingURL=chunk-7V3XRFPG.js.map
