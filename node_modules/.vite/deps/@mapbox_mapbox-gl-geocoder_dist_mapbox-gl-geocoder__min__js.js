    ...
    !function(t) {
      ...
      return function() {
        ...
        r.prototype = { select: function(t3, e2) {
          ...
          if (i2.resultIndex = n2, i2.resultPlaceName = t3.place_name, i2.resultId = t3.id, (n2 !== this.lastSentIndex || i2.queryString !== this.lastSentInput) && -1 != n2 && (this.lastSentIndex = n2, this.lastSentInput = i2.queryString, i2.queryString))
            return this.push(i2);
        }, start: function(t3) {
          ...
          if (t3.key && !t3.metaKey && -1 === [9, 27, 37, 39, 13, 38, 40].indexOf(t3.keyCode)) {
            ...
            if (n2.lastAction = t3.key, n2.queryString)
              return this.push(n2);
          }
        }, send: function(t3, e2) {
          ...
          n2.onreadystatechange = function() {
            if (4 == this.readyState)
              return e2(204 == this.status ? null : this.statusText);
        ...
        function r(t3) {
          this._eventEmitter = new u(), this.options = a({}, this.options, t3), this.inputString = "", this.fresh = true, this.lastSelected = null, this.geolocation = new m();
        }
        var o = t2("suggestions"), s = t2("lodash.debounce"), a = t2("xtend"), u = t2("events").EventEmitter, c = t2("./exceptions"), l = t2("@mapbox/mapbox-sdk"), h = t2("@mapbox/mapbox-sdk/services/geocoding"), p = t2("./events"), f = t2("./localization"), d = t2("subtag"), m = t2("./geolocation"), g = t2("./utils"), y = { FORWARD: 0, LOCAL: 1, REVERSE: 2 };
        r.prototype = { options: { zoom: 16, flyTo: true, trackProximity: true, minLength: 2, reverseGeocode: false, flipCoordinates: false, limit: 5, origin: "https://api.mapbox.com", enableEventLogging: true, marker: true, mapboxgl: null, collapsed: false, clearAndBlurOnEsc: false, clearOnBlur: false, enableGeolocation: false, addressAccuracy: "street", getItemValue: function(t3) {
          ...
          function e2(t4, e3) {
            if (!document.body.contains(e3))
              throw new Error("Element provided to #addTo() exists, but is not in the DOM");
            var n3 = t4.onAdd();
            e3.appendChild(n3);
          }
          if (t3._controlContainer)
            t3.addControl(this);
            ...
            if (0 === n2.length)
              throw new Error("Element ", t3, "not found.");
            if (n2.length > 1)
              throw new Error("Geocoder can only be added to a single html element");
            e2(this, n2[0]);
          }
        }, onAdd: function(t3) {
          if (t3 && "string" != typeof t3 && (this._map = t3), this.setLanguage(), this.options.localGeocoderOnly || (this.geocoderService = h(l({ accessToken: this.options.accessToken, origin: this.options.origin }))), this.options.localGeocoderOnly && !this.options.localGeocoder)
          ...
          this._hideGeolocateButton(), this._showLoadingIcon(), this.geolocation.getCurrentPosition().then((function(t3) {
            ...
            if (this.options.localGeocoderOnly) {
              ...
              this.geocoderService.reverseGeocode(n2).send().then((function(t4) {
                var n3 = t4.body.features[0];
                if (n3) {
                  var i3 = g.transformFeatureToGeolocationText(n3, this.options.addressAccuracy);
                  this._setInputValue(i3), n3.user_coordinates = e2.geometry.coordinates, this._eventEmitter.emit("result", { result: n3 });
                } else
                  this._eventEmitter.emit("result", { result: { user_coordinates: e2.geometry.coordinates } });
              }).bind(this));
          ...
          if (27 === t3.keyCode && this.options.clearAndBlurOnEsc)
            return this._clear(t3), this._inputEl.blur();
          var e2 = t3.target && t3.target.shadowRoot ? t3.target.shadowRoot.activeElement : t3.target;
          if (!(e2 ? e2.value : ""))
            return this.fresh = true, 9 !== t3.keyCode && this.clear(t3), this._showGeolocateButton(), this._hideClearButton();
          ...
          var e2;
          if (t3.properties && c[t3.properties.short_code])
            e2 = a({}, this.options.flyTo), this._map && this._map.fitBounds(c[t3.properties.short_code].bbox, e2);
          else if (t3.bbox) {
            var n2 = t3.bbox;
          ...
          return t3.localGeocoderOnly ? y.LOCAL : t3.reverseGeocode && g.REVERSE_GEOCODE_COORD_RGX.test(e2) ? y.REVERSE : y.FORWARD;
          ...
          var n2 = ["bbox", "limit", "proximity", "countries", "types", "language", "reverseMode", "mode", "autocomplete", "fuzzyMatch", "routing", "worldview"], i2 = /[\s,]+/, r2 = this, o2 = n2.reduce(function(t4, e3) {
            if (void 0 === r2.options[e3] || null === r2.options[e3])
              return t4;
          ...
          return "Search";
        }, setInput: function(t3) {
          return this._inputEl.value = t3, this._typeahead.selected = null, this._typeahead.clear(), t3.length >= this.options.minLength && this._geocode(t3), this;
          ...
          return this.placeholder = t3 || this._getPlaceholderText(), this._inputEl.placeholder = this.placeholder, this._inputEl.setAttribute("aria-label", this.placeholder), this;
        }, getBbox: function() {
      ...
      }, { "./events": 1, "./exceptions": 2, "./geolocation": 3, "./localization": 5, "./utils": 6, "@mapbox/mapbox-sdk": 8, "@mapbox/mapbox-sdk/services/geocoding": 19, events: 28, "lodash.debounce": 31, subtag: 35, suggestions: 36, xtend: 39 }], 5: [function(t2, e, n) {
        "use strict";
        ...
        function i(t3) {
          ...
          return function(i2) {
            var o2 = r(m.plainArray, i2);
            if (o2)
              return o2;
            if (e2 && i2.length !== t3.length)
              return "an array with " + t3.length + " items";
        ...
        var p = t2("is-plain-obj"), f = t2("xtend"), d = "value", m = {};
        m.assert = function(t3, e2) {
          ...
          var e2 = h(t3);
          return function(t4) {
            var n2 = r(m.plainObject, t4);
            if (n2)
              return n2;
            for (var i2, s2, a2 = [], u2 = 0; u2 < e2.length; u2++)
              i2 = e2[u2].key, s2 = e2[u2].value, (n2 = r(s2, t4[i2])) && a2.push([i2].concat(n2));
          ...
          return m.oneOfType.apply(this, e2);
        }, m.range = function(t3) {
          var e2 = t3[0], n2 = t3[1];
          return function(t4) {
            if (r(m.number, t4) || t4 < e2 || t4 > n2)
              return "number between " + e2 + " & " + n2 + " (inclusive)";
          };
        }, m.any = function() {
        }, m.boolean = function(t3) {
          if ("boolean" != typeof t3)
            return "boolean";
        }, m.number = function(t3) {
          if ("number" != typeof t3)
            return "number";
        }, m.plainArray = function(t3) {
          if (!Array.isArray(t3))
            return "array";
        }, m.plainObject = function(t3) {
          if (!p(t3))
            return "object";
        }, m.string = function(t3) {
          if ("string" != typeof t3)
            return "string";
        }, m.func = function(t3) {
          if ("function" != typeof t3)
            return "function";
        }, m.validate = r, m.processMessage = o, e.exports = m;
      ...
      }, { "../constants": 15, "../helpers/url-utils": 18, "@mapbox/parse-mapbox-token": 25, eventemitter3: 27, xtend: 39 }], 14: [function(t2, e, n) {
        "use strict";
        function i(t3, e2) {
        ...
        function u(t3, e2) {
          return e2 ? t3.replace(/\/:([a-zA-Z0-9]+)/g, function(t4, n2) {
            var i2 = e2[n2];
            if (void 0 === i2)
              throw new Error("Unspecified route parameter " + n2);
            return "/" + r(i2);
          }) : t3;
        }
          ...
          (function() {
            ...
            function i(t3) {
              if ("undefined" != typeof window) {
                if (t3 instanceof n2.Blob || t3 instanceof n2.ArrayBuffer)
                  return;
                return "Blob or ArrayBuffer";
              }
              if ("string" != typeof t3 && void 0 === t3.pipe)
            ...
            function o(t3) {
              ...
              try {
                var e2 = new Date(t3);
                if (e2.getTime && isNaN(e2.getTime()))
                  return "date";
              } catch (t4) {
                return "date";
              }
          ...
          (function() {
            ...
            !function(o) {
              ...
              var l = function(t2) {
                ...
                for (var n2, i2, r2 = 0, o2 = "", s2 = -1; ++s2 < e3; )
                  i2 = h.indexOf(t2.charAt(s2)), n2 = r2 % 4 ? 64 * n2 + i2 : i2, r2++ % 4 && (o2 += String.fromCharCode(255 & n2 >> (-2 * r2 & 6)));
                return o2;
              }, d = function(t2) {
                t2 = String(t2), /[^\0-\xFF]/.test(t2) && l("The string to be encoded contains characters outside of the Latin1 range.");
                for (var e3, n2, i2, r2, o2 = t2.length % 3, s2 = "", a2 = -1, u2 = t2.length - o2; ++a2 < u2; )
                  e3 = t2.charCodeAt(a2) << 16, n2 = t2.charCodeAt(++a2) << 8, i2 = t2.charCodeAt(++a2), r2 = e3 + n2 + i2, s2 += h.charAt(r2 >> 18 & 63) + h.charAt(r2 >> 12 & 63) + h.charAt(r2 >> 6 & 63) + h.charAt(63 & r2);
              ...
              }, m = { encode: d, decode: f, version: "0.1.0" };
        ...
        Object.create && (i.prototype = /* @__PURE__ */ Object.create(null), new i().__proto__ || (c = false)), a.prototype.eventNames = function() {
          ...
          if (0 === this._eventsCount)
            return n2;
          for (e2 in t3 = this._events)
            u.call(t3, e2) && n2.push(c ? e2.slice(1) : e2);
          ...
          if (n2.fn)
            return [n2.fn];
          for (var i2 = 0, r2 = n2.length, o2 = new Array(r2); i2 < r2; i2++)
            o2[i2] = n2[i2].fn;
          return o2;
          ...
          if (l.fn) {
            ...
            for (u2 = 1, a2 = new Array(h - 1); u2 < h; u2++)
              a2[u2 - 1] = arguments[u2];
            l.fn.apply(l.context, a2);
          } else {
            var p, f = l.length;
            for (u2 = 0; u2 < f; u2++)
              switch (l[u2].once && this.removeListener(t3, l[u2].fn, void 0, true), h) {
                case 1:
                ...
                default:
                  if (!a2)
                    for (p = 1, a2 = new Array(h - 1); p < h; p++)
                      a2[p - 1] = arguments[p];
          ...
          if (!this._events[r2])
            return this;
          if (!e2)
            return s(this, r2), this;
          var o2 = this._events[r2];
          if (o2.fn)
            o2.fn !== e2 || i2 && !o2.once || n2 && o2.context !== n2 || s(this, r2);
          else {
            for (var a2 = 0, u2 = [], l = o2.length; a2 < l; a2++)
              (o2[a2].fn !== e2 || i2 && !o2[a2].once || n2 && o2[a2].context !== n2) && u2.push(o2[a2]);
        ...
        function s(t3, e2, n2) {
          if (e2)
            ...
            for (var i2 = t3.length, r2 = y(t3, i2), o2 = 0; o2 < i2; ++o2)
              r2[o2].call(n2);
        }
        function a(t3, e2, n2, i2) {
          if (e2)
            ...
            for (var r2 = t3.length, o2 = y(t3, r2), s2 = 0; s2 < r2; ++s2)
              o2[s2].call(n2, i2);
        }
        function u(t3, e2, n2, i2, r2) {
          if (e2)
            ...
            for (var o2 = t3.length, s2 = y(t3, o2), a2 = 0; a2 < o2; ++a2)
              s2[a2].call(n2, i2, r2);
        }
        function c(t3, e2, n2, i2, r2, o2) {
          if (e2)
            ...
            for (var s2 = t3.length, a2 = y(t3, s2), u2 = 0; u2 < s2; ++u2)
              a2[u2].call(n2, i2, r2, o2);
        }
        ...
        function p() {
          if (!this.fired)
            switch (this.target.removeListener(this.type, this.wrapFn), this.fired = true, arguments.length) {
              ...
              default:
                for (var t3 = new Array(arguments.length), e2 = 0; e2 < t3.length; ++e2)
                  t3[e2] = arguments[e2];
        ...
        function g(t3, e2) {
          for (var n2 = e2, i2 = n2 + 1, r2 = t3.length; i2 < r2; n2 += 1, i2 += 1)
            t3[n2] = t3[i2];
          t3.pop();
        }
        function y(t3, e2) {
        ...
        function v(t3) {
          for (var e2 = new Array(t3.length), n2 = 0; n2 < e2.length; ++n2)
            e2[n2] = t3[n2].listener || t3[n2];
          return e2;
        }
        function b(t3) {
          var e2 = function() {
        ...
        L ? Object.defineProperty(r, "defaultMaxListeners", { enumerable: true, get: function() {
          ...
          switch (i2 = arguments.length) {
            ...
            case 4:
              ...
              break;
            default:
              for (r2 = new Array(i2 - 1), o2 = 1; o2 < i2; o2++)
          ...
          if (n2 === e2 || n2.listener === e2)
            0 == --this._eventsCount ? this._events = x(null) : (delete i2[t3], i2.removeListener && this.emit("removeListener", t3, n2.listener || e2));
            ...
            if (r2 < 0)
              return this;
            0 === r2 ? n2.shift() : g(n2, r2), 1 === n2.length && (i2[t3] = n2[0]), i2.removeListener && this.emit("removeListener", t3, s2 || e2);
          }
          return this;
          ...
          if (!n2.removeListener)
            return 0 === arguments.length ? (this._events = x(null), this._eventsCount = 0) : n2[t3] && (0 == --this._eventsCount ? this._events = x(null) : delete n2[t3]), this;
          if (0 === arguments.length) {
            var r2, o2 = E(n2);
            for (i2 = 0; i2 < o2.length; ++i2)
              "removeListener" !== (r2 = o2[i2]) && this.removeAllListeners(r2);
            return this.removeAllListeners("removeListener"), this._events = x(null), this._eventsCount = 0, this;
          }
          if ("function" == typeof (e2 = n2[t3]))
            this.removeListener(t3, e2);
          else if (e2)
            for (i2 = e2.length - 1; i2 >= 0; i2--)
              this.removeListener(t3, e2[i2]);
          return this;
        ...
        !function() {
          ...
          void 0 !== n ? e.exports = i : t3.fuzzy = i, i.simpleFilter = function(t4, e2) {
            ...
            for (var p = 0; p < s; p++)
              i2 = e2[p], h[p] === t4[r] ? (i2 = c + i2 + l, r += 1, u += 1 + u) : u = 0, a += u, o[o.length] = i2;
        ...
        (function(t3) {
          (function() {
            ...
            function i(t4, e2, n3) {
              function i2(e3) {
                var n4 = m2, i3 = g2;
                return m2 = g2 = void 0, O = e3, v2 = t4.apply(i3, n4);
              }
              function o2(t5) {
              ...
              function h2(t5) {
                return b2 = void 0, A && m2 ? i2(t5) : (m2 = g2 = void 0, v2);
              }
              function p2() {
                void 0 !== b2 && clearTimeout(b2), O = 0, m2 = _2 = g2 = b2 = void 0;
              }
              function f2() {
              ...
              function d2() {
                var t5 = E(), n4 = c2(t5);
                if (m2 = arguments, g2 = this, _2 = t5, n4) {
                  if (void 0 === b2)
                    return o2(_2);
                  if (k)
                    return b2 = setTimeout(l2, e2), i2(_2);
                }
                return void 0 === b2 && (b2 = setTimeout(l2, e2)), v2;
              }
              var m2, g2, y2, v2, b2, _2, O = 0, L = false, k = false, A = true;
            ...
            function a(t4) {
              ...
              t4 = t4.replace(h, "");
              var n3 = f.test(t4);
              return n3 || d.test(t4) ? m(t4.slice(2), n3 ? 2 : 8) : p.test(t4) ? c : +t4;
            }
            var u = "Expected a function", c = NaN, l = "[object Symbol]", h = /^\s+|\s+$/g, p = /^[-+]0x[0-9a-f]+$/i, f = /^0b[01]+$/i, d = /^0o[0-7]+$/i, m = parseInt, g = "object" == (void 0 === t3 ? "undefined" : n2(t3)) && t3 && t3.Object === Object && t3, y = "object" == ("undefined" == typeof self ? "undefined" : n2(self)) && self && self.Object === Object && self, v = g || y || Function("return this")(), b = Object.prototype, _ = b.toString, w = Math.max, x = Math.min, E = function() {
              return v.Date.now();
            };
            e.exports = i;
          }).call(this);
        ...
        (function(n2) {
          (function() {
            ...
            if ("production" !== n2.env.NODE_ENV) {
              if ("undefined" != typeof navigator && "ReactNative" === navigator.product && "undefined" == typeof crypto)
            ...
            var o = function(t3) {
              ...
              return function() {
                for (var o2 = ""; ; )
                  for (var s2 = n3(r2), a2 = r2; a2--; )
                    if (o2 += t3[s2[a2] & i2] || "", o2.length === e2)
                      return o2;
              };
            }, a = function(t3, e2) {
              return s(t3, e2, o);
        ...
        function o(t3) {
          ...
          if ((h === i || !h) && setTimeout)
            return h = setTimeout, setTimeout(t3, 0);
          try {
            return h(t3, 0);
          } catch (e2) {
            try {
        ...
        function a() {
          g && d && (g = false, d.length ? m = d.concat(m) : y = -1, m.length && u());
        }
        function u() {
          if (!g) {
            var t3 = o(a);
        ...
        f.nextTick = function(t3) {
          ...
          m.push(new c(t3, e2)), 1 !== m.length || g || o(u);
        ...
        i.prototype.show = function() {
          ...
          for (var t3 = 0; t3 < this.items.length; t3++)
            this.drawItem(this.items[t3], this.active === t3);
          this.show();
        ...
        s.prototype.handleKeyUp = function(t3) {
          ...
          if (t3.clipboardData)
            this.handleInputChange(t3.clipboardData.getData("Text"));
          else {
            var e2 = this;
            setTimeout(function() {
          ...
          if (this.query = this.normalize(t3), this.list.clear(), this.query.length < this.options.minLength)
