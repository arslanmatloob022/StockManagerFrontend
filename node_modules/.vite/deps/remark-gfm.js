...
function tokenizeTable(effects, ok2, nok) {
  ...
  function headRowBreak(code2) {
    ...
    if (markdownSpace(code2)) {
      return factorySpace(effects, headRowBreak, types3.whitespace)(code2);
    }
    sizeB += 1;
    if (seen) {
      seen = false;
  ...
  function headRowData(code2) {
    if (code2 === codes4.eof || code2 === codes4.verticalBar || markdownLineEndingOrSpace3(code2)) {
  ...
  function headDelimiterValueBefore(code2) {
    ...
    if (code2 === codes4.eof || markdownLineEnding(code2)) {
  ...
  function bodyRowBreak(code2) {
    ...
    if (markdownSpace(code2)) {
      return factorySpace(effects, bodyRowBreak, types3.whitespace)(code2);
    }
    effects.enter(types3.data);
...
function spaceThenNonSpace(effects, ok2, nok) {
  return factorySpace(effects, after, types4.whitespace);
  function after(code2) {
    return code2 === codes5.eof ? nok(code2) : ok2(code2);
  }
}
...
function previous(match, email) {
  ...
  return (match.index === 0 || unicodeWhitespace5(code2) || unicodePunctuation5(code2)) && (!email || code2 !== 47);
}
